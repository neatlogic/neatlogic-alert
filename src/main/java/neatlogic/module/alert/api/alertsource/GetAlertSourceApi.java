...
public class GetAlertSourceApi extends PrivateApiComponentBase {
    ...
    @Description(desc = "获取告警来源")
    @Override
    public Object myDoService(JSONObject jsonObj) throws IOException {
        String name = jsonObj.getString("name");
        return alertSourceMapper.getAlertSourceByName(name);
    }
}
