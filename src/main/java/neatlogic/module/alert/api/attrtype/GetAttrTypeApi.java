...
public class GetAttrTypeApi extends PrivateApiComponentBase {
    ...
    @Description(desc = "获取告警扩展属性")
    @Override
    public Object myDoService(JSONObject jsonObj) {
        Long id = jsonObj.getLong("id");
        return alertAttrTypeMapper.getAttrTypeById(id);
    }
