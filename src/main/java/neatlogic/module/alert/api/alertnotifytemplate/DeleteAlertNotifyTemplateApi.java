...
public class DeleteAlertNotifyTemplateApi extends PrivateApiComponentBase {
    ...
    public String getToken() {
        return "alert/notifytemplate/delete";
    }
    ...
    @Description(desc = "删除通知模板")
    @Override
    public Object myDoService(JSONObject jsonObj) {
        Long id = jsonObj.getLong("id");
        alertNotifyTemplateMapper.deleteNotifyTemplateById(id);
        return null;
    }
