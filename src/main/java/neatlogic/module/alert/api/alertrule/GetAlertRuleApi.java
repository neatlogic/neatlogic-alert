...
public class GetAlertRuleApi extends PrivateApiComponentBase {
    ...
    @Description(desc = "获取告警规则")
    @Override
    public Object myDoService(JSONObject jsonObj) throws IOException {
        return alertRuleMapper.getAlertRuleById(jsonObj.getLong("id"));
    }
}
