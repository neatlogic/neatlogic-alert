...
public class DeleteAttrTypeApi extends PrivateApiComponentBase {
    ...
    @Description(desc = "删除告警扩展属性")
    @Override
    public Object myDoService(JSONObject jsonObj) {
        Long id = jsonObj.getLong("id");
        alertAttrTypeMapper.deleteAttrTypeById(id);
        return null;
    }
