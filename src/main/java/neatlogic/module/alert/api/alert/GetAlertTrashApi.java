...
public class GetAlertTrashApi extends PrivateApiComponentBase {
    ...
    @Output({
            @Param(explode = AlertTrashVo.class)
    })
    @Description(desc = "获取告警详情")
    @Override
    public Object myDoService(JSONObject jsonObj) throws IOException {
        return alertTrashMapper.getAlertTrashById(jsonObj.getLong("id"));
    }
}
