...
public class ListAlertTopoApi extends PrivateApiComponentBase {
    ...
    @Output({@Param(explode = AlertTopoVo[].class)})
    @Description(desc = "列出所有告警拓扑")
    @Override
    public Object myDoService(JSONObject jsonObj) {
        AlertTopoVo topoVo = JSON.toJavaObject(jsonObj, AlertTopoVo.class);
        topoVo.setIsActive(1);
        return alertTopoMapper.listAlertTopo(topoVo);
    }
}
